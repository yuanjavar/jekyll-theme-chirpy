...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-wiki-zh.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-java.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-callable.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/future-get.png)

![img.png](http://127.0.0.1:4000/assets/md/java/futuretask.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/os-thread-state.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-timed-waiting.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-state.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-code.png)

![img.png](http://127.0.0.1:4000/assets/md/java/runnable-code.png)

![img.png](http://127.0.0.1:4000/assets/md/java/thread-code2.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/jvm-start0.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/jvm-start0-thread.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/jvm-javathread.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/jvm-pthread.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/jvm-thread-start.png)


在 thread.cpp源码中，thread->call_run() 调用了 thread_main_inner()。
![img.png](http://127.0.0.1:4000/assets/md/java/jvm-thread.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/threadmain.png)

在 jvm.cpp源码中，thread_entry方法中，JVM通过 JavaCall模块调用了 Java中的 run()方法。
![img.png](http://127.0.0.1:4000/assets/md/java/javacall.png)

通过上面对 JDK和 JVM的源码分析，我们可以把 Thread.start()的整个执行过程整理成下图：

![img.png](http://127.0.0.1:4000/assets/md/java/thread-start.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-group.png)
...
![img.png](http://127.0.0.1:4000/assets/md/java/thread-group-tree.png)
